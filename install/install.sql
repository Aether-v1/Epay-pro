...
INSERT INTO `pre_config` VALUES ('admin_pwd', '!INSTALL_REQUIRED!'); -- A1: 安装时必须设置强密码，此值不可登录
INSERT INTO `pre_config` VALUES ('admin_paypwd', '!INSTALL_REQUIRED!'); -- A1: 安装时必须设置支付密码
