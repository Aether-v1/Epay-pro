...
// Batch C Phase2: 数据清理权限检查
require_permission('data.clean');
$title='系统数据清理';
include './head.php';
...
showmsg('清理系统设置缓存成功！',1);
	...
	// Batch C Phase2: 清理订单数据审计
	admin_audit_log('清理订单数据', '');
...
<h4>自定义清理：</h4>
<form action="./clean.php?mod=cleanorderi" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
...
<form action="./clean.php?mod=cleansettlei" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
...
<form action="./clean.php?mod=cleanrecordi" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
...
<form action="./clean.php?mod=cleantransferi" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
...
<form action="./clean.php?mod=cleanpsorderi" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
...
<form action="./clean.php?mod=cleanlogi" method="post" role="form"><input type="hidden" name="do" value="submit"/><?= csrf_field() ?>
