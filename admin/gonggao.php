...
<div class="panel-body">
	<form action="./gonggao.php?my=edit_submit&id=<?php echo $id?>" role="form" class="form-horizontal" method="post"><?= csrf_field() ?>
...
if($sds){
	...
	safe_error_log('添加公告失败', $DB->error());
	showmsg('添加公告失败！',4);
}
}
...
if($sds!==false){
	...
	safe_error_log('修改公告失败', $DB->error());
	showmsg('修改公告失败！',4);
}
}else{
...
<div class="panel-body">
	<form action="./gonggao.php?my=add_submit" role="form" class="form-horizontal" method="post"><?= csrf_field() ?>
		<div class="list-group-item">
			<div class="input-group">
				<div class="input-group-addon">公告内容</div>
