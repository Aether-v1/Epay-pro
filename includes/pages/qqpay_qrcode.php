<?php
// QQ钱包扫码支付页面（Phase 2-F1：统一二维码组件，QQ 特殊逻辑保留）
...
<body class="epay-page epay-qr-page epay-channel--qqpay">
<div class="epay-card">
  <div class="epay-head">
  ...
  <h1 class="epay-qr-page__title"><span class="epay-channel-ico" aria-hidden="true"><svg viewBox="0 0 24 24"><text x="12" y="16.5" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff" font-family="inherit">Q</text></svg></span>QQ钱包扫码支付</h1>
  <p class="epay-qr-page__subtitle">使用手机 QQ 扫一扫完成付款</p>
  ...
  <div class="epay-qr">
    ...
    <div class="epay-qr__help">请使用手机 QQ 扫描二维码完成支付</div>
  </div>
...
<script>
    ...
    if(code_type == 0){
        ...
        $('#qrcode').empty().append($('<img>', {src: code_url, alt: 'QQ收款二维码'}));
    }
    // 订单详情
    ...
    function loadmsg() {
        $.ajax({
            ...
            dataType: "json",
            url: "/getshop.php",
            data: {type: "qqpay", trade_no: trade_no},
