...
<div class="epay-card">  <div class="epay-head">
  ...
  <div class="epay-transition">
    ...
    <h1 class="epay-transition__title">正在打开支付宝</h1>
  ...
  <div class="epay-h5-actions">
    <a href="javascript:;" id="openUrl" class="epay-btn epay-btn--primary epay-btn--block">打开支付宝</a>
    <a href="javascript:checkresult()" class="epay-btn epay-btn--ghost epay-btn--block">已完成支付？检测支付结果</a>
  </div>

  <p class="epay-h5-hint">若未自动打开支付宝，请点击上方按钮继续支付</p>  <div class="epay-trust">
