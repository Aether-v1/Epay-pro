...
<div class="epay-card">  <div class="epay-head">
  ...
  <h1 class="epay-qr-page__title"><span class="epay-channel-ico" aria-hidden="true"><svg viewBox="0 0 24 24"><text x="12" y="16.5" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff" font-family="inherit">♪</text></svg></span>抖音扫码支付</h1>
  <p class="epay-qr-page__subtitle">请使用抖音APP扫描二维码完成支付</p>
  ...
  <div class="epay-qr">
    ...
    <div class="epay-qr__help">请使用手机抖音扫描二维码完成支付</div>
  </div>
  ...
  <div class="epay-h5-actions">
    <a href="snssdk1128://" class="epay-btn epay-btn--primary epay-btn--block">打开抖音APP</a>
  ...
  <p class="epay-h5-hint">提示：你可将以上二维码链接发到自己抖音的聊天框（在抖音消息页面顶部搜索框可以搜到自己的账号），点击即可进入支付！</p>  <div class="epay-trust">
