...
<body class="epay-page epay-h5-page epay-channel--wechat">
<div class="epay-card">  <div class="epay-head">
  ...
  <div class="epay-transition">
    <div class="epay-transition__icon"><span class="epay-channel-ico" aria-hidden="true"><svg viewBox="0 0 24 24"><text x="12" y="16.5" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff" font-family="inherit">微</text></svg></span></div>
    <h1 class="epay-transition__title">正在打开微信支付</h1>
  ...
  <div class="epay-h5-actions">
    <a href="javascript:;" id="openUrl" class="epay-btn epay-btn--primary epay-btn--block">打开微信支付</a>
    <a href="javascript:checkresult()" class="epay-btn epay-btn--ghost epay-btn--block">已完成支付？检测支付结果</a>
  </div>

  <p class="epay-h5-hint">若未自动打开微信，请点击上方按钮继续支付</p>  <div class="epay-trust">
