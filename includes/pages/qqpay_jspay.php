...
document.body.addEventListener('touchmove', function (event) {
	...
	{
		mqq.tenpay.pay({
			tokenId: <?php echo json_encode($tokenId, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>,
			appInfo: <?php echo json_encode($appInfo, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>
