...
function loadmsg() {
	$.ajax({
		...
		dataType: "json",
		url: "/getshop.php",
		data: {type: "douyinpay", trade_no: <?php echo json_encode(TRADE_NO, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>},
