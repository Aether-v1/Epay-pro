...
<body class="epay-page epay-h5-page epay-channel--douyinpay">
<div class="epay-card">  <div class="epay-head">
  ...
  <div class="epay-transition">
    <div class="epay-transition__icon"><span class="epay-channel-ico" aria-hidden="true"><svg viewBox="0 0 24 24"><text x="12" y="16.5" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff" font-family="inherit">♪</text></svg></span></div>
    <h1 class="epay-transition__title">正在打开抖音支付</h1>
  ...
  <div class="epay-h5-actions">
    <a href="javascript:;" id="openUrl" class="epay-btn epay-btn--primary epay-btn--block">打开抖音APP支付</a>
    <a href="javascript:checkresult()" class="epay-btn epay-btn--ghost epay-btn--block">已完成支付？检测支付结果</a>
  </div>

  <p class="epay-h5-hint">请点击上方按钮在抖音APP中完成支付</p>  <div class="epay-trust">
...
<script>
    var url_scheme = <?php echo json_encode($code_url, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>;
    function loadmsg() {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "/getshop.php",
            data: { type: "douyinpay", trade_no: <?php echo json_encode($order['trade_no'], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?> },
