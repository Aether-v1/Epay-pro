...
class epay_plugin
{
	...
	static public function refund($order){
		...
		if(!is_array($result) || !array_key_exists('code', $result)){
			return ['code'=>-2, 'msg'=>'上游响应格式异常（UNKNOWN）'];
		}
		if($result['code'] === 0 || $result['code'] === '0'){
			return ['code'=>0];
		}elseif(is_int($result['code']) || is_string($result['code'])){
			return ['code'=>-1, 'msg'=>isset($result['msg'])?$result['msg']:'上游明确拒绝'];
		}else{
			return ['code'=>-2, 'msg'=>'上游返回未知结果（UNKNOWN）'];
		}
	}
